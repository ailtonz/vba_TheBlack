...
Public Function SaidaLog(strConteudo As String, strArquivo As String)
...
Public Function ExportarXLS(strConsulta As String)
    Dim sTemp As String
    
    sTemp = pathDesktopAddress & Format(Now, "yymmdd_hhnn") & "-" & strConsulta & "_" & Left(CurrentMDB(), Len(CurrentMDB()) - 4) & ".xls"
